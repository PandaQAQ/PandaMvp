package com.pandaq.pandamvp.basefunc;
...
public class GuideCoverView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        setBackgroundColor(context.getResources().getColor(R.color.color_guide_cover));
    ...
    public void setAlginType(AlignType alginType) {
        mAlignType = alginType;
    }
