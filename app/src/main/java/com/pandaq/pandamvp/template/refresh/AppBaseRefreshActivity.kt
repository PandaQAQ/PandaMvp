...
import com.pandaq.pandamvp.template.AppBaseActivity
 ...
 * Description :模板类
 */
abstract class AppBaseRefreshActivity<P : AppBaseRefreshPresenter<*>,VB:ViewBinding> : AppBaseActivity<P,VB>(), IListVIew {
