 ...
 */
public class PandaCardView extends FrameLayout {
    ...
    public PandaCardView(Context context) {
        super(context);
        initialize(context, null, 0);
    }

    public PandaCardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs, 0);
    }

    public PandaCardView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private final PandaCardViewDelegate mCardViewDelegate = new PandaCardViewDelegate() {
        ...
        @Override
        public boolean getUseCompatPadding() {
            return PandaCardView.this.getUseCompatPadding();
        }

        @Override
        public boolean getPreventCornerOverlap() {
            return PandaCardView.this.getPreventCornerOverlap();
        }

        @Override
        public void setShadowPadding(int left, int top, int right, int bottom) {
            mShadowBounds.set(left, top, right, bottom);
            PandaCardView.super.setPadding(left + mContentPadding.left, top + mContentPadding.top,
        ...
        public void setMinWidthHeightInternal(int width, int height) {
            if (width > mUserSetMinWidth) {
                PandaCardView.super.setMinimumWidth(width);
            }
            if (height > mUserSetMinHeight) {
                PandaCardView.super.setMinimumHeight(height);
            }
        }
