...
public class FloatingActionButton extends AppCompatImageButton {
    ...
    void init(Context context, AttributeSet attributeSet) {
        ...
        mColorPressed = attr.getColor(R.styleable.FloatingActionButton_fab_colorPressed, Color.parseColor("#e4e4e4"));
    ...
    void updateBackground() {
        ...
        @SuppressLint("UseCompatLoadingForDrawables") LayerDrawable layerDrawable = new LayerDrawable(
                new Drawable[]{
