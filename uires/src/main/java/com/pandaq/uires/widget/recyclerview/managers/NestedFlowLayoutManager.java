 ...
 * <p>
 * Description : Recyclerview 流式布局 manager
 */
public class NestedFlowLayoutManager extends RecyclerView.LayoutManager {

    private static final String TAG = NestedFlowLayoutManager.class.getSimpleName();
    private final NestedFlowLayoutManager self = this;
    ...
    public NestedFlowLayoutManager() {
