...
class ToastConfig {
    ...
    var normalTextColor: Int =
        AppUtils.getContext().resources.getColor(R.color.res_colorTextSuccess)

    // 正常 Icon 图标
    var normalIcon: Drawable =
        AppUtils.getContext().resources.getDrawable(R.drawable.ic_toast_success)
    ...
    // 警告文本颜色
    @ColorInt
    var warningTextColor: Int =
        AppUtils.getContext().resources.getColor(R.color.res_colorTextWarning)

    // 警告 Icon 图标
    var warningIcon: Drawable =
        AppUtils.getContext().resources.getDrawable(R.drawable.ic_toast_warning)
